...
$sql_sp = "SELECT * FROM sanpham,dmsanpham where sanpham.id_dm=dmsanpham.id_dm and sanpham.id_dm='$id_dm' limit 6";
$query_sp = mysqli_query($connect, $sql_sp);
$sql_dm = "SELECT * FROM dmsanpham limit 4";
$query_dm = mysqli_query($connect, $sql_dm);
//  $sql_title = mysqli_fetch_assoc($query_dm);
//  $title = $sql_title['ten_dm'];
?>
<!DOCTYPE html>
<html>
        ...
        <?php } 
                ...
                <div class="col-sm-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="Home.php">Trang chủ</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Tour ngoài nước</li>
                        </ol>
                    </nav>
                </div>
            </div>
